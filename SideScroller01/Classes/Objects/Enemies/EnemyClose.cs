...
namespace SideScroller01.Classes.Objects.Enemies
{
    ...
    class EnemyClose : Actor
    {
        ...
        public override void GetHit(DirectionTarget cameFrom, int damage)
        {
            ...
            this.state = EnemyCloseState.TakeHit;
        ...
        private void AnimateKnockDown(GameTime gT)
        {
            ...
            if (this.CurrentFrameTime >= Actor.FrameRate * 1.2f)
            {
                ...
                if (this.FrameX > 7)
                {
                    ...
                    {
                        this.state = EnemyCloseState.Dying;
                        this.stateTime = 1f;
                        this.FrameX = 6;
                        return;
                    }
                    ...
                    // Set state and texture
                    this.state = EnemyCloseState.Down;
                    this.FrameX = 6;
                    this.stateTime = 0f;
                    return;
                }
        ...
        private void AnimateAttack1(GameTime gT)
        {
            ...
            if (this.CurrentFrameTime >= Actor.FrameRate * 0.5f)
            {
                ...
                {
                    // Setup Attack 02 
                    this.InitSpriteFrames(D_WIDTH_COMBO1_ATTACK02, this.DrawHeight, 0, 1);
        ...
        private void AnimateAttack2(GameTime gT)
        {
            ...
            if (this.CurrentFrameTime >= Actor.FrameRate * 0.8f)
            {
                ...
                {
                    // Setup Attack 02 
                    this.InitSpriteFrames(D_WIDTH_COMBO1_ATTACK03, this.DrawHeight, 0, 3);
                ...
                // Collision Detection
                if (this.FrameX == 6) this.CheckPlayerCollision();
