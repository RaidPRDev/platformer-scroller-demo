...
namespace BloomPostprocess
{
    public class Bloom
    {
        ...
        {                        
            ...
            sceneRenderTarget = new RenderTarget2D(device, pp.BackBufferWidth, pp.BackBufferHeight, false, format, DepthFormat.None);
            finalRenderTarget = new RenderTarget2D(device, pp.BackBufferWidth, pp.BackBufferHeight, false, format, DepthFormat.None);
        ...
        public void EndDraw()
        {
            ...
            spriteBatch.Draw(finalRenderTarget, new Rectangle(0, 0, 800, 600), Color.White); // draw all glowing components            
            spriteBatch.End();
        }
        ...
        public void SetBloom(float a, float b)
        {
