...
namespace SideScroller01
{
    ...
    {
        private static readonly int HealthBarWidth = 200;
        private static readonly int HealthBarHeight = 16;

        public static float Opacity;
        public static float HealthOpacity = 0;

        private static Level currentLevel;
        private static Texture2D playerHud;
        private static Texture2D itemRocks;
        ...
        public static void DrawHUD(SpriteBatch SBHUD)
        {
            ...
            {
                if (HealthOpacity <= 0.2f) HealthOpacity += 0.003f;
            ...
            {
                if (HealthOpacity > 0f) HealthOpacity -= 0.003f;

                SBHUD.Draw(singlePixel, new Rectangle(0, 0, Game1.SCREEN_WIDTH, Game1.SCREEN_HEIGHT),
                        new Color(Color.Black, HealthOpacity));
            }
            ...
            SBHUD.Draw(singlePixel, new Vector2(66, Game1.SCREEN_HEIGHT - 45),
                new Rectangle(0,0,drawWidth, HealthBarHeight), Color.Yellow);

            // Draw Player One Avatar
            SBHUD.Draw(playerHud, new Vector2(10, Game1.SCREEN_HEIGHT - playerHud.Height), Color.White);
            ...
            // Draw Black Bar
            /*
            SBHUD.Draw(singlePixel, new Rectangle(0, 0, Game1.SCREEN_WIDTH, 140), new Color(Color.Black, 0.4f));
            ...
            */
            ...
            {
                SBHUD.Draw(itemRocks, new Vector2(300, Game1.SCREEN_HEIGHT - 46), Color.White);
            }
        ...
        {
            if (Opacity <= 0.4f) Opacity += 0.003f;
        ...
        {
            if (Opacity <= 0.85f) Opacity += 0.003f;
